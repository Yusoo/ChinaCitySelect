...
function china_city_select() {
	...
	// 默认值
	$province_container.val($province_container.data('val')).change();
	$city_container.val($city_container.data('val')).change();
	$area_container.val($area_container.data('val')).change();
}